    ...
    <div style={{
      ...
      <header style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.9rem' }}>
          ...
          {/* Notification Bell (Pure White Icon & Dot) */}
            ...
            {showProfileMenu && (
              <div style={{
                ...
                <div style={{ padding: '0.4rem 0.55rem', borderBottom: `1px solid ${theme.border}`, marginBottom: '0.45rem' }}>
                  <div style={{ fontSize: '13px', fontWeight: 800, color: '#FFFFFF' }}>Amit</div>
                ...
                >
                  <AdminPanelSettingsRoundedIcon sx={{ fontSize: 16, color: '#FFFFFF' }} />
      ...
      {/* Main Body Layout: Totally Black Sidebar + Content */}
      <div style={{
        flex: 1,
        minHeight: 0,
        display: 'flex',
        ...
        <aside style={{
          ...
          <div>
            ...
            {/* Horizontal Divider Line from screenshot */}
            <div style={{
              margin: '1rem 0.5rem',
            ...
            <button
              ...
              style={{
                ...
                padding: isSidebarOpen ? '0.65rem 0.9rem' : '0.65rem 0',
                borderRadius: '0.75rem',
                border: activeTabId === 'shift' ? '1px solid #FFFFFF' : '1px solid transparent',
                backgroundColor: activeTabId === 'shift' ? '#FFFFFF' : 'transparent',
        ...
        <main style={{
          ...
          <div style={{ maxWidth: '1120px', margin: '0 auto' }}>
            ...
            {/* Exactly 3 KPI Cards from Screenshot: Today's Sales | Orders | Customers */}
            <div style={{
              display: 'grid',
              ...
              <div
                style={{
                  backgroundColor: '#0A0A0A',
                  border: `1px solid ${hoveredCard === 'customers' ? '#FFFFFF' : '#242424'}`,
                  borderRadius: '1.15rem',
                  padding: '1.4rem 1.5rem',
                  display: 'flex',
                  flexDirection: 'column',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <ScheduleRoundedIcon sx={{ fontSize: 22, color: '#FFFFFF' }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', marginBottom: '1.5rem' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.65rem 0.85rem', backgroundColor: '#141416', borderRadius: '0.65rem', border: '1px solid #222224' }}>
                <span style={{ fontSize: '13px', color: '#A1A1AA' }}>Manager on Duty</span>
                <span style={{ fontSize: '13px', fontWeight: 700, color: '#FFFFFF' }}>Amit (SP CAFE)</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.65rem 0.85rem', backgroundColor: '#141416', borderRadius: '0.65rem', border: '1px solid #222224' }}>
                <span style={{ fontSize: '13px', color: '#A1A1AA' }}>Shift Started</span>
                <span style={{ fontSize: '13px', fontWeight: 700, color: '#FFFFFF' }}>Today, 08:00 AM</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.65rem 0.85rem', backgroundColor: '#141416', borderRadius: '0.65rem', border: '1px solid #222224' }}>
                <span style={{ fontSize: '13px', color: '#A1A1AA' }}>Opening Cash Float</span>
                <span style={{ fontSize: '13px', fontWeight: 700, color: '#FFFFFF' }}>₹5,000</span>
              </div>
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0.65rem 0.85rem', backgroundColor: '#141416', borderRadius: '0.65rem', border: '1px solid #222224' }}>
                <span style={{ fontSize: '13px', color: '#A1A1AA' }}>Current Cash in Drawer</span>
                <span style={{ fontSize: '14px', fontWeight: 800, color: '#FFFFFF' }}>₹28,450</span>
              </div>
            </div>
